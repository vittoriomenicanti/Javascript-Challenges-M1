...
let year = prompt("Please type any Year in number format");

let month = prompt("Please type any Month in number format"); 

let day = prompt("Please type any Day in number format"); 
